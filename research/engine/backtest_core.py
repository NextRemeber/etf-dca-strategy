...
V31_CONFIG = dict(
    # v3.4 (2026-08-25): 红利低波 512890 → 563020 (同指数, 费率 0.60%→0.20%/年); 闸门已移除
    amounts={"513100": 2000.0, "563020": 2000.0, "159985": 2000.0,
             "159819": 2000.0, "518880": 2000.0},
    graded={"159819", "518880"},                       # S3 分档标的
    rotate_groups=[(["513100", "563020"], 0.30), (["159819", "518880"], 0.15)],
    premium_gate={},
)
